...
{
    /**
     * The language files the shop actually loads on this line. On 6.5 the admin theme is
     * named "admin", so views/admin/<lang>/ is read and views/admin_twig/ is not.
     */
