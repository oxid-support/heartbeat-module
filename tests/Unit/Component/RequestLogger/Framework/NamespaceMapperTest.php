...
use OxidSupport\Heartbeat\Component\RequestLogger\Framework\NamespaceMapper;
...
final class NamespaceMapperTest extends TestCase
{
    ...
    public function testGetControllerNamespaceMappingReturnsCorrectNamespace(): void
    {
        ...
        $this->assertArrayHasKey('OxidSupport\\Heartbeat\\Component\\RequestLogger\\Controller\\GraphQL', $mapping);
    }
    ...
    public function testGetControllerNamespaceMappingReturnsValidPath(): void
    {
        ...
        $path = $mapping['OxidSupport\\Heartbeat\\Component\\RequestLogger\\Controller\\GraphQL'];
    ...
    public function testGetTypeNamespaceMappingReturnsCorrectNamespace(): void
    {
        ...
        $this->assertIsArray($mapping);
        $this->assertArrayHasKey('OxidSupport\\Heartbeat\\Component\\RequestLogger\\DataType', $mapping);
    }
    ...
    public function testGetTypeNamespaceMappingReturnsValidPath(): void
    {
        ...
        $path = $mapping['OxidSupport\\Heartbeat\\Component\\RequestLogger\\DataType'];
    ...
    public function testControllerMappingDoesNotIncludeAdminSubdirectory(): void
    {
        ...
        $this->assertArrayNotHasKey('OxidSupport\\Heartbeat\\Component\\RequestLogger\\Controller\\Admin', $mapping);
    }
