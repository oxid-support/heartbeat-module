...
{
    /** @var ApiUserProvisioningServiceInterface */
    private $apiUserProvisioningService;

    /** @var SetupTokenServiceInterface */
    private $setupTokenService;

    public function __construct(
        ApiUserProvisioningServiceInterface $apiUserProvisioningService,
        SetupTokenServiceInterface $setupTokenService
    ) {
        $this->apiUserProvisioningService = $apiUserProvisioningService;
